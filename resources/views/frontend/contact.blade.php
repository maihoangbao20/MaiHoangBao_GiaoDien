...
<body>
      ...
      <div class="container">
            ...
            <div class="col-12 col-md-9">
               <nav class="navbar navbar-expand-lg bg-main">
                  <div class="container-fluid">
                     <a class="navbar-brand d-block d-sm-none text-white" href="index.html">SHOP</a>
                     ...
                     <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                                   <li class="nav-item">
          <a class="nav-link text-white" href="http://localhost/MaiHoangBao_CCQ2211AB/">Trang chủ</a>
        </li>
                               
                            
                                                    
                                                                   <li class="nav-item">
         <a class="nav-link text-white" href="index.php?option=page&cat=gioi-thieu">Giới thiệu</a>
        </li>
                               
                            
                                                    
                                                               <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-white" href="index.php?option=product&cat=do-nam" role="button"
        ...
        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item text-main" href="index.php?option=product&cat=quan-dai-nam">Quần dài nam</a></li>
                                                               ...
                                                               <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-white" href="index.php?option=product&cat=do-nu" role="button"
            data-bs-toggle="dropdown" aria-expanded="false">
            Đồ nữ        </a>
        <ul class="dropdown-menu">
 ...
 <!-- Start Contact -->
    ...
    <ul>
        ...
        <li>Số điện thoại: <a href="tel:+1234567890">0964654938</a></li>
        <li>Địa chỉ: 15 đường số 9, Thành phố Thủ Đức</li>
    </ul>
    <h3>Google Map</h3>
    <div class="map my-3">
        <iframe src="https://www.google.com/maps/place/Trung+T%C3%A2m+Y+T%E1%BA%BF+TP.+Th%E1%BB%A7+%C4%90%E1%BB%A9c/@10.8333142,106.7701883,16z/data=!4m10!1m2!2m1!1zMjIgxJDGsOG7nW5nIHPhu5EgOSBUxINuZyBOaMahbiBQaMO6IEIgUXXhuq1uIDkgVGjDoG5oIHBo4buRIEjhu5MgQ2jDrSBNaW5o!3m6!1s0x317527037c26848d:0x9e3c6e351a85457e!8m2!3d10.8333142!4d106.7797155!15sCksyMiDEkMaw4budbmcgc-!16s%2Fg%2F1pp2v2_lp?hl=vi&entry=ttu" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div> 
    </div>
<!-- End Contact -->
